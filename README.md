...
├── spine_sim/
│   ├── model.py             # SpineModel and Newmark integrator
│   ├── model_components.py  # Spine element builder (Raj stiffnesses)
│   ├── model_paths/         # Model type registry
│   ├── calibration.py       # Calibration algorithms
│   ├── calibration_store.py # Calibration file I/O
│   ├── calibration_targets.py # Yoganandan target peaks
│   ├── toen_drop.py         # Toen buttocks model
│   ├── toen_subjects.py     # Toen subject data
│   ├── toen_targets.py      # Toen floor stiffnesses
│   ├── toen_store.py        # Toen calibration I/O
│   ├── filters.py           # CFC filter
│   ├── io.py                # CSV parsing
│   ├── range.py             # Hit range detection
│   ├── plotting.py          # Visualization
│   └── env.py               # Environment variable helpers
├── calibration/
│   ├── yoganandan/          # Calibration input files
│   ├── toen_drop.json       # Buttocks calibration output
│   └── zwt.json             # Spine calibration output
├── drops/                   # Input drop test CSVs
├── output/                  # Simulation outputs
└── opensim/
    └── fullbody.json        # Extracted mass data
```
